<?php
/**
 * CommunityControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Community Module
 *
 * @category Test
 * @package Community
...
namespace OnePlaceTest\Community\Controller;

use OnePlace\Community\Controller\CommunityController;
...
class CommunityControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/community', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('community');
        $this->assertControllerName(CommunityController::class); // as specified in router's controller name alias
        $this->assertControllerClass('CommunityController');
        $this->assertMatchedRouteName('community');
    }
    ...
    public function testAddActionCanBeAccessed() {
        ...
        $this->dispatch('/community/add', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('community');
        $this->assertControllerName(CommunityController::class); // as specified in router's controller name alias
        $this->assertControllerClass('CommunityController');
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/community/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('community');
        $this->assertControllerName(CommunityController::class); // as specified in router's controller name alias
        $this->assertControllerClass('CommunityController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/community/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('community');
        $this->assertControllerName(CommunityController::class); // as specified in router's controller name alias
        $this->assertControllerClass('CommunityController');
