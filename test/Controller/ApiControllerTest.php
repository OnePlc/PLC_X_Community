...
use OnePlace\Community\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCannotBeAccessedWithoutKey() {
        $this->dispatch('/community/api', 'GET');
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/community/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('community-api');
    }
}
