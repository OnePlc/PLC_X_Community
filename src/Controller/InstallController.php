...
class InstallController extends CoreUpdateController {
    ...
    public function checkdbAction()
    {
        ...
        $this->setThemeBasedLayout('community');
        ...
        if(! $oRequest->isPost()) {
            ...
            return new ViewModel([
                ...
                'sVendor' => 'oneplace',
                'sModule' => 'oneplace-community',
            ]);
        } else {
            $sSetupConfig = $oRequest->getPost('plc_module_setup_config');

            $sSetupFile = 'vendor/oneplace/oneplace-community/data/install.sql';
            ...
            if($sSetupConfig != '') {
                $sConfigStruct = 'vendor/oneplace/oneplace-community/data/structure_'.$sSetupConfig.'.sql';
                ...
                $sConfigData = 'vendor/oneplace/oneplace-community/data/data_'.$sSetupConfig.'.sql';
            ...
            $oModTbl->insert([
                'module_key'=>'oneplace-community',
                'type'=>'module',
                'version'=>\OnePlace\Community\Module::VERSION,
                'label'=>'onePlace Community',
                'vendor'=>'oneplace',
            ]);
            ...
            $this->flashMessenger()->addSuccessMessage('Community DB Update successful');
