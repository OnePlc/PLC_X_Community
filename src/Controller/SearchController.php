<?php
/**
 * SearchController.php - Community Search Controller
 *
 * Main Controller for Community Search
 *
 * @category Controller
 * @package Community
...
class SearchController extends CoreSearchController
{
    ...
    /**
     * Dump Community data to desired format
     *
     * @return bool
     * @since 1.0.0
     */
    public function indexAction() {
         ...
         * Hooks available:
         *
         * community-search-before (before show search form)
         * community-search-before-execute (before query)
         * community-search-after-execute (after query - before show results)
         */
        return $this->generateSearchView('community');
    }
}